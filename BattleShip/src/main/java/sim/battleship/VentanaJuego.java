...
public class VentanaJuego {
    ...
    public void display(String title, String message) {
        ...
        Button btnTerminarPartida = new Button("Terminar Partida");
        btnTerminarPartida.setOnAction(e -> {
            terminarPartida();
        });
        Button btnDispararAll = new Button("Disparar Todo");
        btnDispararAll.setOnAction(e -> {
            disparoAll();
        });
        ...
        newLayout.getChildren().addAll(lblMsg, btnSalir, btnDisparar, btnTerminarPartida, btnDispararAll);
    ...
    private void finalizarJuego() {
        ...
        gameTerminado.display("Fin del Juego", ganoPlayer1,mensaje, partida.porcentajesAciertos(), partida.totales());
        reset();
